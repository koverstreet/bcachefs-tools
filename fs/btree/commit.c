 ...
 *
 * BTREE_TRIGGER_norun writes the key verbatim, so nothing can charge and the
 * reservation can't be needed - that's how journal replay and the fsck
 * error-injection tests lay down deliberately bad keys.
 */
